...
namespace Mod1_Lab2
{
    ...
    public class Car
    {
        ...
        // This constructor instantiates a Car() object while only having the car's year and mileages information available
        ...
        // Creates integer variable called "instances" and assigns calue to 0
        private static int instances = 0;

        public Car()
        {
            // Everytime the constuctor runs, increment "instances"
            instances++;
        }
